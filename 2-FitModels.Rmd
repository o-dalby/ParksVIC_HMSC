...
fishStudyDesign <- data.frame(Fyear = fishS$year, protection = fishS$MPAProtectStat, siteID = fishS$site_name, bioregion = fishS$Bioregion)
...
rL.fish.nngp <- HmscRandomLevel(sData = xy, longlat = TRUE, sMethod = 'NNGP',nNeighbours = 10)
#rL.fish.nngp <- setPriors(rL.fish.nngp,nfMin=1,nfMax=1) Currently letting the model run with default spatial priors. 24.6.2024


#Repeat for inverts
invertStudyDesign <- data.frame(Fyear = invertS$year, protection = invertS$MPAProtectStat, siteID = invertS$site_name, siteID = invertS$site_name, bioregion = invertS$Bioregion)
...
rL.invert.nngp <- HmscRandomLevel(sData = xy, longlat = TRUE, sMethod = 'NNGP',nNeighbours = 10)
#rL.invert.nngp <- setPriors(rL.invert.nngp, nfMin=1,nfMax=1) #Again, letting spatial priors be default at this point
