...
TerrainMetrics = Qfit(VICBathy5m, w = c(9,9), na.rm = TRUE, 
                      ...
                      filename = "test.tif", overwrite = TRUE) #Calculate all available metrics bar the features variable
...
Now we've got the wave predictors wrangled and exported (but notably not interpolated quite yet) we can rinse and repeat for the temperature data. This data is sourced from the AODN (Australian Ocean Data Network). MORE DETAILS NEEDED.
