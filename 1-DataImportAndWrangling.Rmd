...
First off, not all the years we have predictor data for are actually in our response data. Let's import the resposne data and muck around wtih it.

```{r}
#Import fish and invert response data
fishData = read.csv("Z:/GIS-Res/Projects/ParksVic_Hmsc/ResponseData/CoarseLatLon/Final_Fish_AbundanceMatrix.csv")
invertData = read.csv("Z:/GIS-Res/Projects/ParksVic_Hmsc/ResponseData/CoarseLatLon/Final_Inverts_AbundanceMatrix.csv")
...
setwd("Z:/GIS-Res/Projects/ParksVic_Hmsc/ResponseData/CoarseLatLon/")
fishYears = fishDataSf$Year %>% unique()
fishYears %>% saveRDS("fishYears")
invertYears = invertDataSf$Year %>% unique()
fishYears %>% saveRDS("fishYears")
