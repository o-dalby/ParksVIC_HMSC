...
vp = read.csv(file.path(outputs.directory,
                        "parameter_estimates_VP_fish_presence_absence_model_chains_4_samples_250_thin_10.csv"),
...
plotGradient(focalModel, Gradient, pred=predY, measure="Y", index = 57, showData = TRUE)
...
#Grab Variance Partitioning csv and pivot to a format we like
vp = read.csv(file.path(outputs.directory,
                        "parameter_estimates_VP_invert_presence_absence_model_chains_4_samples_250_thin_10.csv"),
              stringsAsFactors = TRUE)
...
#Grab Variance Partitioning csv and pivot to a format we like
vp = read.csv(file.path(outputs.directory,
                        "parameter_estimates_VP_fish_abundance_COP_model_chains_4_samples_250_thin_10.csv"),
              stringsAsFactors = TRUE)
...
predY = predict(focalModel, Gradient=Gradient, expected = TRUE)
focalModel$spNames #Print species names
plotGradient(focalModel, Gradient, pred=predY, measure="Y", index = 7, showData = TRUE)
plotGradient(focalModel, Gradient, pred=predY, measure="S", showData = TRUE)
...
#Grab Variance Partitioning csv and pivot to a format we like
vp = read.csv(file.path(outputs.directory,
                        "parameter_estimates_VP_invert_abundance_COP_model_chains_4_samples_250_thin_10.csv"),
              stringsAsFactors = TRUE)
...
ggsave(filename = "MPAStatus TotalAbundance.tif",
        path = file.path(outputs.directory,"InvertACOP/Gradients"),
        gradient_plot, height = 5, width = 5, units = "cm")
